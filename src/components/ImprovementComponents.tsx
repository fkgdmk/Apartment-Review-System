...
const ExpenseFields = function (props: IExpenseFieldsProps) {
    ...
    const { calculatedValue, materialsExpense, totalExpense } = props;
...
export const Calculated = function (props : ICalculatedProps) {
    const { hourPrUnit, hourPrice, hours, materialPrice, impairmentPercentage, ExpenseFieldsProps, onChangeHourPrice, onChangeHourPrUnit, onChangeHours, onChangeImpairmentPercentage, onChangeMaterialPrice} = props;
    return (
        <div className="own-work">
            <div>
                <TextField label="t/enh." type="number" value={hourPrUnit?.toString()} onChange={onChangeHourPrUnit} />
                <TextField label="Timer" type="number" value={hours?.toString()} onChange={onChangeHours} />
            ...
            <div>
                ...
                <TextField label="Timepris" value={hourPrice?.toString()} type="number" placeholder={'kr.'} onChange={onChangeHourPrice} />
            </div>
...
export const Materials = function (props : any) : JSX.Element {
    const { hourPrUnit, hourPrice, hours, materialPrice, impairmentPercentage, ExpenseFieldsProps } = props;
